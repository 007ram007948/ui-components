const About1 = () => {
  return (
    <>
      <section className=" p-5 overflow-hidden pt-20 pb-12 lg:pt-[120px] lg:pb-[90px] bg-white">
...
export const About1Code = `const About1 = () => {
  return (
    <>
      <section className=" p-5 overflow-hidden pt-20 pb-12 lg:pt-[120px] lg:pb-[90px] bg-white">
        <div className="loader"></div>
          ...
          <div className="flex flex-wrap items-center justify-between -mx-4">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                ...
                <a
                  href="javascript:void(0)"
                  className="inline-flex items-center justify-center py-3 text-base
                   font-medium text-center text-white border border-transparent
