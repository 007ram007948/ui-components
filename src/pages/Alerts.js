      ...
      <div class="container mx-auto">
        <div class="-mx-4 flex flex-wrap justify-center">
          <div class="w-full space-y-11 px-4 lg:w-10/12">
            <div class="flex w-full rounded-lg border-l-[6px] border-transparent bg-white px-7 py-8 shadow-1 dark:bg-dark-2 md:p-9">
              <div class="mr-5 flex h-[34px] w-full max-w-[34px] items-center justify-center rounded-md bg-yellow/30 text-yellow-dark">
                <svg
                  width="18"
                  height="18"
                  viewBox="0 0 18 18"
            ...
            <div class="flex w-full rounded-lg border-l-[6px] border-yellow bg-yellow-light-4 px-7 py-8 md:p-9">
              <div class="mr-5 flex h-[34px] w-full max-w-[34px] items-center justify-center rounded-md bg-yellow">
                <svg
                  width="18"
                  height="18"
                  viewBox="0 0 18 18"
            ...
            <div class="flex max-w-[655px] items-center rounded-md border-l-[6px] border-l-yellow bg-white p-5 pl-6 dark:bg-dark-2">
              <div class="mr-5 flex h-[36px] w-full max-w-[36px] items-center justify-center rounded-full bg-yellow">
                <svg
                  width="18"
                  height="18"
                  viewBox="0 0 18 18"
              ...
              <div class="flex w-full items-center justify-between">
                ...
                <div>
                  <button class="text-dark-3 duration-300 hover:text-dark dark:text-dark-4 dark:hover:text-dark-6">
                    <svg
                      width="20"
                      height="20"
                      viewBox="0 0 20 20"
            ...
            <div class="flex w-full rounded-lg border-l-[6px] border-green bg-white px-7 py-8 shadow-1 dark:bg-dark-2 md:p-9">
              <div class="mr-5 flex h-[34px] w-full max-w-[34px] items-center justify-center rounded-md bg-green/10">
                <svg
                  width="18"
                  height="18"
                  viewBox="0 0 18 18"
              ...
              <div class="w-full">
                <h5 class="mb-3 text-lg font-semibold text-dark dark:text-white">
                ...
                <div class="flex">
                  ...
                  <button class="text-sm font-medium text-dark hover:text-body-color dark:text-dark-6">
                    Dismiss
                  </button>
                </div>
              </div>
            ...
            <div class="flex w-full rounded-lg border-l-[6px] border-green bg-green-light-6 px-7 py-8 md:p-9">
              <div class="mr-5 flex h-[34px] w-full max-w-[34px] items-center justify-center rounded-md bg-green">
                <svg
                  width="18"
                  height="18"
                  viewBox="0 0 18 18"
            ...
            <div class="flex w-full rounded-lg border-l-[6px] border-transparent bg-white px-7 py-8 shadow-1 dark:bg-dark-2 md:p-9">
              <div class="mr-5 flex h-[34px] w-full max-w-[34px] items-center justify-center rounded-lg bg-red-light-5 text-red-dark dark:bg-red-dark dark:text-white">
                <svg
                  width="18"
                  height="18"
                  viewBox="0 0 18 18"
            ...
            <div class="flex w-full rounded-lg border-l-[6px] border-red bg-red-light-6 px-7 py-8 shadow-[0px_2px_10px_0px_rgba(0,0,0,0.08)] md:p-9">
              <div class="mr-5 flex h-[34px] w-full max-w-[34px] items-center justify-center rounded-lg bg-red">
                <svg
                  width="18"
                  height="18"
                  viewBox="0 0 18 18"
            ...
            <div class="flex w-full rounded-lg border-l-[6px] border-transparent bg-white px-7 py-8 shadow-1 dark:bg-dark-2 md:p-9">
              <div class="mr-5 flex h-[34px] w-full max-w-[34px] items-center justify-center rounded-md bg-cyan-light-2/30 text-cyan-dark">
                <svg
                  width="18"
                  height="18"
                  viewBox="0 0 18 18"
            ...
            <div class="flex w-full rounded-lg border-l-[6px] border-cyan-dark bg-[#E9F9FF] px-7 py-8 md:p-9">
              <div class="mr-5 flex h-[34px] w-full max-w-[34px] items-center justify-center rounded-md bg-cyan-dark text-white">
                <svg
                  width="18"
                  height="18"
                  viewBox="0 0 18 18"
            ...
            <div class="flex max-w-[655px] items-center rounded-md border-l-[6px] border-l-cyan-dark bg-white p-5 pl-6 dark:bg-dark-2">
              <div class="mr-5 flex h-[36px] w-full max-w-[36px] items-center justify-center rounded-full bg-cyan-dark text-white">
                <svg
                  width="18"
                  height="18"
                  viewBox="0 0 18 18"
...
const Alerts = () => {
  return (
    <ComponentShowcase
      pageTitle="About"
      components={[
        { component: <AlertsComponent />, codeString: AlertsComponentCode },
      ]}
    />
  );
};
